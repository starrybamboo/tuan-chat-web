...
export default function STImportModal({
  isOpen,
  onClose,
  characterData,
  onImportSuccess,
    ...
    <dialog className="modal modal-open">
      <div className="modal-box max-w-2xl">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold">ST指令导入</h3>
            <p className="text-sm text-base-content/70">使用.st指令快速导入角色属性数据</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="relative w-full">
            <textarea
              className="textarea textarea-bordered rounded-md w-full min-h-[150px] bg-base-100 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary resize-y"
