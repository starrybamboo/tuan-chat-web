...
export const AiImageSidebar = memo(({ sidebarProps }: AiImageSidebarProps) => {
  ...
  const infillAppendInputClassName = "block w-full max-w-[360px] resize-none overflow-hidden rounded-md border border-[#D6DCE3] bg-[#F3F5F7] px-3 py-2 text-sm leading-6 text-base-content transition focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-[#2A3138] dark:bg-[#161A1F]";
