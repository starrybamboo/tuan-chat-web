...
export function useAiImagePageController() {
  ...
  const workspaceProps = useMemo(() => buildWorkspaceProps({
    isDirectorToolsOpen,
    previewPaneProps: {
      isDirectorToolsOpen,
      previewMeta,
    ...
    selectedPreviewResult,
    selectedResultIndex,
    setActiveDirectorTool,
    setDirectorColorizeDefry,
    setDirectorColorizePrompt,
    setDirectorEmotion,
    setDirectorEmotionDefry,
    setDirectorEmotionExtraPrompt,
    setIsHistoryExpanded,
    directorTool,
  ]);

  const metadataImportDialogProps = useMemo(() => buildMetadataImportDialogProps({
    pendingMetadataImport,
  ...
  const previewImageDialogProps = useMemo(() => buildPreviewImageDialogProps({
    isOpen: isPreviewImageModalOpen,
    selectedPreviewResult,
    selectedPreviewHistoryRow,
    onClose: () => setIsPreviewImageModalOpen(false),
    onDownloadCurrent: handleDownloadCurrent,
  }), [handleDownloadCurrent, isPreviewImageModalOpen, selectedPreviewHistoryRow, selectedPreviewResult]);

  const inpaintDialogProps = useMemo(() => buildInpaintDialogProps({
  ...
  }), [error, handleCloseInpaintDialog, handleSaveInpaintMask, inpaintDialogSource, loading]);

  const stylePickerDialogProps = useMemo(() => buildStylePickerDialogProps({
