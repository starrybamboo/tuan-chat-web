...
export default function CommandPanel({ prefix, handleSelectCommand }: { prefix: string; handleSelectCommand: (cmdName: string) => void }) {
  const suggestionNumber = 10;
  const isCommandMode = prefix.startsWith(".") || prefix.startsWith("。");
