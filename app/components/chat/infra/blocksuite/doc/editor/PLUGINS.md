...
- 调用 [quickSearchService.ts](../../services/quickSearchService.ts) 提供 service 适配层
- 具体 picker DOM 控制器实现在 [blocksuiteQuickSearchPicker.ts](../../editors/extensions/blocksuiteQuickSearchPicker.ts)
