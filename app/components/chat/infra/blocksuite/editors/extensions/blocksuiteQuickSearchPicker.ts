...
export function createBlocksuiteQuickSearchPicker(params: {
  ...
  const searchDoc = async ({ userInput }: SearchDocParams): Promise<SearchDocResult | null> => {
    dispose();
