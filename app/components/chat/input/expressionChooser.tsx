...
export function ExpressionChooser({
  ...
  return (
    <div className="flex flex-col md:flex-row w-full max-w-[92vw] md:max-w-[720px] lg:max-w-[840px] min-w-0 max-h-[70vh] md:max-h-[50vh] overflow-hidden">
      {/* 左侧：角色列表 */}
      ...
      {/* 右侧：表情列表 */}
      <div className="w-full md:w-2/5 min-w-0 md:min-w-[220px] lg:min-w-[320px] md:pl-3">
        {/* 旁白模式下不显示表情 */}
        {isNarratorMode
          ? (
