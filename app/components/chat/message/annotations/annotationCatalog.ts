...
const BUILTIN_ANNOTATIONS: AnnotationDefinition[] = [
  ...
  { id: "figure.anim.ba-down", label: "下落", category: "动作", tone: "accent", source: "builtin", icon: ActionDownIcon, hideLabel: true, showInNormalMode: true },
  { id: "figure.anim.ba-left-falldown", label: "左倒", category: "动作", tone: "accent", source: "builtin", icon: ActionFallLeftIcon, hideLabel: true, showInNormalMode: true },
  { id: "figure.anim.ba-right-falldown", label: "右倒", category: "动作", tone: "accent", source: "builtin", icon: ActionFallRightIcon, hideLabel: true, showInNormalMode: true },
  { id: "figure.anim.ba-jump-twice", label: "二连跳", category: "动作", tone: "accent", source: "builtin", icon: ActionJumpTwiceIcon, hideLabel: true, showInNormalMode: true },
  { id: "figure.anim.ba-jump", label: "跳跃", category: "动作", tone: "accent", source: "builtin", icon: ActionJumpIcon, hideLabel: true, showInNormalMode: true },
  { id: "figure.anim.ba-shake", label: "摇晃", category: "动作", tone: "accent", source: "builtin", icon: ActionShakeIcon, hideLabel: true, showInNormalMode: true },
  { id: "figure.anim.ba-bigshake", label: "大摇晃", category: "动作", tone: "accent", source: "builtin", icon: ActionBigShakeIcon, hideLabel: true, showInNormalMode: true },
  ...
  { id: "figure.anim.exit", label: "淡出", category: "立绘", tone: "accent", source: "builtin", icon: FadeOutIcon, hideLabel: true, showInNormalMode: true },
  { id: "figure.anim.ba-enter-from-right", label: "从右入场", category: "立绘", tone: "accent", source: "builtin", icon: EnterFromRightIcon, hideLabel: true, showInNormalMode: true },
  { id: "figure.anim.ba-exit-to-right", label: "从右退场", category: "立绘", tone: "accent", source: "builtin", icon: ExitToRightIcon, hideLabel: true, showInNormalMode: true },
