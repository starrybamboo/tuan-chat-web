...
export default function WebgalChooseMessage({ payload }: { payload: WebgalChoosePayload | null }) {
  ...
  return (
    <div className="
      rounded-xl border border-base-content/10 bg-base-100/70 px-3 py-2 text-sm
      shadow-sm backdrop-blur
    ">
      <div className="flex items-center gap-2 text-xs text-base-content/60">
        <span className="
          inline-flex items-center rounded-full border border-base-content/20
          bg-base-100 px-2 py-0.5 text-[10px] font-semibold tracking-wide
