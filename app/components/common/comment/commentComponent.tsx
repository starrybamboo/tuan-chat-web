    ...
    <div className="card bg-base-100 shadow-sm mb-4 text-base-content">
      <div className="card-body p-4">
        ...
        <div className="card-actions justify-end mt-2">
          <button className="btn btn-sm btn-ghost text-base-content hover:text-primary">
        ...
        {commentVO.children && commentVO.children.length > 0 && (
          <div className="mt-4 pl-4 border-l-2 border-base-200">
            ...
            {commentVO.hasMore && (
              <button className="btn btn-sm btn-ghost mt-2 text-base-content hover:text-primary">
                Load more replies (
