...
hover:rotate-[9deg] hover:scale-110 hover:brightness-90 dark:hover:brightness-110`}
      ...
      <div className="absolute top-20 right-10 z-10">
        <div className="btn-group">
          {[3, 4, 5].map(n => (
            <button
              key={n}
              className={`btn btn-sm ${columnCount === n ? "btn-primary" : "btn-ghost"}`}
      ...
      <div
        className="flex-1 overflow-y-auto pl-8 pt-20 pr-20"
        style={{
      ...
      >
        {feeds.map((feed, index) => (
          <div
            ...
            className="cursor-pointer mb-8 break-inside-avoid" // 防止卡片被拆断
          >
