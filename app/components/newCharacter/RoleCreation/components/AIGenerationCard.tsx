      ...
      <div className="card-body mt-4 mb-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-4">
            <button
              type="button"
              className="btn btn-primary text-white rounded-md flex-1 bg-gradient-to-r from-purple-500 to-pink-500 border-none"
              onClick={onGenerate}
            ...
            <button type="button" className="btn btn-outline rounded-md text-purple-400" onClick={onExcelImport}>
              Excel导入
            </button>
          </div>
        </div>
