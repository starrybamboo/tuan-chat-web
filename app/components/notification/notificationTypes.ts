...
export const NOTIFICATION_CATEGORY_FEEDBACK_ISSUE_CREATED = "FEEDBACK_ISSUE_CREATED" as const;
export const NOTIFICATION_CATEGORY_FEEDBACK_STATUS_CHANGED = "FEEDBACK_STATUS_CHANGED" as const;
export const NOTIFICATION_CATEGORY_FEEDBACK_ARCHIVED = "FEEDBACK_ARCHIVED" as const;
export const NOTIFICATION_CATEGORY_FEEDBACK_COMMENT_ADDED = "FEEDBACK_COMMENT_ADDED" as const;
export const NOTIFICATION_CATEGORY_FEEDBACK_COMMENT_REPLIED = "FEEDBACK_COMMENT_REPLIED" as const;
