    ...
    <div className="flex flex-col gap-0.5 w-full px-1 py-1">
      {
        realTimeContacts.length === 0
          ? (
              <div className="flex flex-col items-center justify-center text-base-content/50 px-4 py-8 gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="size-8 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
