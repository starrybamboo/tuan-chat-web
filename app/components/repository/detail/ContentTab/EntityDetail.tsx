...
const EntityDetail: React.FC<EntityDetailProps> = ({ repositoryInfo }) => {
  const [selectedEntityVersionId, setSelectedEntityVersionId] = useState<string | number | null>(null);

  const selectedEntity = useMemo(() => {
    if (selectedEntityVersionId === null || !Array.isArray(repositoryInfo)) {
      return null;
    }
    return repositoryInfo.find((entity, index) => getEntityVersionId(entity, index) === selectedEntityVersionId) || null;
  }, [selectedEntityVersionId, repositoryInfo]);
