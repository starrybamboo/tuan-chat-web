...
function EntityList({ repositoryData: repositoryInfo, entityType = "item" }: ItemsProps) {
  // 选中的实体唯一标识符为name
  ...
  const entityList: any[] = useMemo(() => {
    return getEntityListByType(repositoryInfo, entityType);
  }, [repositoryInfo, entityType]);
