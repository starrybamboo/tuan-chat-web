...
interface CollectionListDetailDesktopProps {
 ...
 * 居中弹窗模式
 */
export function CollectionListDetailDesktop({
  collectionList,
  isLoading = false,
  isOpen,
  onClose,
  ...
  onDelete,
  onRemoveResource,
}: CollectionListDetailDesktopProps) {
  // 获取收藏列表中的资源
      ...
      <div className="modal-box w-11/12 max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="border-t pt-6">
          ...
          {resources.length === 0
            ...
            : (
                <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-h-96 overflow-y-auto">
...
export default CollectionListDetailDesktop;
