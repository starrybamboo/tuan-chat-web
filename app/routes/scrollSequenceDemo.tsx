...
const NATIVE_SCROLL_DOCUMENT_CLASS = "scroll-sequence-demo-native-scroll";

function useNativeDocumentScroll() {
  useLayoutEffect(() => {
    document.documentElement.classList.add(NATIVE_SCROLL_DOCUMENT_CLASS);
    document.body.classList.add(NATIVE_SCROLL_DOCUMENT_CLASS);

    return () => {
      document.documentElement.classList.remove(NATIVE_SCROLL_DOCUMENT_CLASS);
      document.body.classList.remove(NATIVE_SCROLL_DOCUMENT_CLASS);
    };
  }, []);
}
