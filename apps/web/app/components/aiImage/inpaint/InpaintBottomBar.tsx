  ...
  return (
    <>
      <div className="pointer-events-none absolute bottom-16 right-4 z-20">
        <div className={`
          pointer-events-auto flex items-center gap-1.5 px-2
          ${sharedPanelClassName}
        `}>
          <button
            type="button"
      ...
      <div className="
        pointer-events-none absolute bottom-2 left-1/2 z-20 w-[830px]
        max-w-[calc(100vw-6rem)] -translate-x-1/2
      ">
        <div className={`
          pointer-events-auto flex h-[50px] items-stretch justify-between gap-0
          px-2
          ${sharedPanelClassName}
        `}>
                    ...
                    <div id="inpaint-mask-color-panel" className={boardPanelClassName}>
                      ...
                      <RangeInput
                        ...
                        className="
                          ...
                          [&::-moz-range-track]:bg-base-content/10
                          [&::-moz-range-thumb]:size-4
                          [&::-moz-range-thumb]:rounded-full
                          [&::-moz-range-thumb]:border-0
                          [&::-moz-range-thumb]:bg-base-content
                        "
