  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 gap-4 overflow-hidden p-4">
        <div className={`
          flex w-[128px] shrink-0 flex-col gap-2
        ...
        `}>
          ...
          <div
            className="
              flex-1 space-y-2 overflow-y-auto overflow-x-hidden pr-5
                  ...
                  return (
                    ...
                    >
                      <button
                        type="button"
                        className="
                          absolute right-2 top-2 z-10 inline-flex size-6
                          items-center justify-center rounded-md bg-transparent
                          text-base-content/62 opacity-0 transition
            ...
            <div className={directorCanvasClassName}>
              ...
              {directorInputPreview
                ? (
                    <>
                      <div className={`
                        ${directorCornerActionsClassName}
                        left-3
                      `}>
                        <button
                          type="button"
