...
export function LoggedInView({ handleLogout }: LoggedInViewProps) {
  return (
    <div className="space-y-4">
      <div className="rounded-md border border-success/20 bg-success/10 px-4 py-3 text-center">
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        <Link to="/" className={buttonClassName({ variant: "primary", className: "w-full gap-2" })}>
