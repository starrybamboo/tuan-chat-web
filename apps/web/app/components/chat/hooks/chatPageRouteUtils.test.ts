import {
  buildPrivateChatRoomPath,
  getDocRouteInfo,
  getIsRoomSettingRoute,
...
describe("chatPageRouteUtils", () => {
  ...
  describe("getSpaceDetailRouteTab", () => {
    it("returns tab for valid space detail route", () => {
      ...
      expect(getSpaceDetailRouteTab({ isPrivateChatMode: false, urlRoomId: "roles" })).toBe("roles");
      ...
      expect(getSpaceDetailRouteTab({ isPrivateChatMode: false, urlRoomId: "material" })).toBe("material");
    });
