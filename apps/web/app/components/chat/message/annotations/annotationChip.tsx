...
const TONE_STYLES: Record<AnnotationTone, string> = {
  ...
  accent: "border-info/40 bg-base-100/78 text-info hover:border-info/60 hover:bg-base-100/88",
  primary: "border-info/40 bg-base-100/78 text-info hover:border-info/60 hover:bg-base-100/88",
};
