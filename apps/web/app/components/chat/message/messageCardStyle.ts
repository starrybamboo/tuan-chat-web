...
const CHAT_MESSAGE_HOVER_TOOLBAR_BASE_CLASS = "absolute top-2 right-2 z-30 flex items-center gap-1 rounded-full border border-base-300/80 bg-base-200/95 px-1.5 py-1 shadow-lg backdrop-blur-sm transition-all duration-150";
