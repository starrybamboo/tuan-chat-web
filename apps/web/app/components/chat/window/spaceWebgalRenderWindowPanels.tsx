                ...
                {renderableRooms.map((room) => {
                  ...
                  return (
                    <div
                      ...
                      "
                      role="group"
                      aria-label={`房间 ${roomName}（ID ${room.roomId}）：${roomStatusMeta.label}，${state.messageCount} 条消息`}
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          <div className="text-sm font-medium truncate" title={roomName}>{roomName}</div>
