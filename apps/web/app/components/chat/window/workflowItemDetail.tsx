...
import { useContentPermission } from "@/components/common/toastWindow/contentPermissionContext";

type WorkflowItemDetailProps = {
  itemName: string;
  itemList: any[];
}

function WorkflowItemDetail({ itemName, itemList }: WorkflowItemDetailProps) {
...
export default memo(WorkflowItemDetail);
