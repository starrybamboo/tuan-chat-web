...
export function Disclosure({
  ...
  return (
    ...
    >
      <summary
        className={`flex min-h-control-default cursor-pointer list-none items-center gap-2 rounded-md px-4 py-3 text-component-title font-medium text-base-content hover:bg-base-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-info/20 [&::-webkit-details-marker]:hidden ${hideTitleOnMobile ? "hidden md:flex" : ""} ${titleClassName}`}
      >
        {icon}
