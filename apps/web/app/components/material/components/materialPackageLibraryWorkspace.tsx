    ...
    <button
      ...
      <div className="flex h-full flex-col">
        ...
        <div className="px-1 text-base">
          <div className="
            mt-4 text-lg font-bold leading-7 text-base-content line-clamp-2
          ">
            {title}
          </div>
          <div className="
            mt-3 text-sm leading-relaxed text-base-content/80 line-clamp-3
          ">
            {description}
          </div>
...
export default function MaterialPackageLibraryWorkspace({
  ...
  return (
    <div ref={scrollRootRef} className={`
      h-full min-h-0 overflow-y-auto text-base-content
      ${embedded ? `bg-base-300/40` : `
        bg-[radial-gradient(circle_at_top_left,oklch(var(--p)/0.1),transparent_26%),linear-gradient(180deg,oklch(var(--b2)/0.98),oklch(var(--b1)/1))]
    ...
    `}>
      {embedded && (
        ...
        ">
          ...
          ">
            ...
            ">
              <div className="
                min-w-0 flex-1 truncate text-sm font-semibold text-base-content
              ">{title}</div>
              <span className="
            ...
            <div className="
              ...
              sm:w-auto sm:flex-row sm:items-center sm:justify-end sm:gap-2
            ">
      ...
      `}>
        <div className="space-y-8">
          {embedded && (
            <div className="
              relative overflow-hidden rounded-xl border border-base-300
              bg-info/10
            ">
              <SparkleIcon
                aria-hidden="true"
              ...
              ">
                <div className="
                  text-2xl font-extrabold tracking-tight text-base-content
                  sm:text-4xl
                ">
                  {title === "我的素材包" ? "这里是你的素材包" : "探索公开的素材包"}
                </div>
                <div className="
                  mt-3 max-w-2xl text-sm text-base-content/70
                  sm:text-base
                ">
                  {title === "我的素材包"
            ...
            <>
              ...
              ">
                <div className="max-w-3xl">
                  ...
                  <h1 className="
                    mt-3 text-3xl font-semibold tracking-tight text-base-content
                    sm:text-4xl
                    md:text-6xl
                  ">{title}</h1>
                  <p className="
                    mt-4 max-w-2xl text-sm leading-7 text-base-content/62
                    md:text-base
                  ">
                    {description}
                  </p>
              ...
              <div className="
                rounded-3xl border border-base-300 bg-base-100/80 px-4 py-3
                shadow-lg
                sm:px-5 sm:py-4
              ">
          ...
          {!loading && (hasMore || loadingMore) && (
            <div ref={loadMoreTriggerRef} className="
              flex min-h-14 items-center justify-center py-2
            ">
              {loadingMore
                ? (
                    <div className="
