...
import type { MessageEditorBlockDriverKind } from "./messageEditorRegistry";
import type { MessageEditorMessage } from "./messageEditorTypes";

import { MessageEditorAtomicBlock } from "./block/MessageEditorAtomicBlock";
import { MessageEditorTextBlock } from "./block/MessageEditorTextBlock";
    ...
    : (
      <div ref={setShellRef} className={shellClassName} aria-describedby={syncProblem ? `${blockId}-sync-problem` : undefined}>
        ...
        <div
          ...
          className="
            select-none
            **:[[contenteditable='true']]:select-text
            [&_input]:select-text
            [&_select]:select-text
