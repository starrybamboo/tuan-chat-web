...
import type { MessageEditorInsertBlockResult, MessageEditorSelectionTextResult } from "../model/messageEditorTextTransforms";
...
import { getAdjacentMessageEditorTextBlockPoint } from "./messageEditorSelection";

type MessageEditorTransactionPlannerParams = {
 ...
 */
export type MessageEditorTransactionPlanner = {
 ...
 */
class MessageEditorDocumentTransactionPlanner implements MessageEditorTransactionPlanner {
  constructor(private readonly params: MessageEditorTransactionPlannerParams) {}
 ...
 * 创建读取当前文档快照的编辑事务规划器。
 */
export function createMessageEditorTransactionPlanner(
  params: MessageEditorTransactionPlannerParams,
): MessageEditorTransactionPlanner {
  return new MessageEditorDocumentTransactionPlanner(params);
}
