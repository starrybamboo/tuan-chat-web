...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    optimizeDeps: {
      // Force-bundle CJS deps used by upstream TS sources.
      include: [
      ...
      // These upstream packages may ship sources that require Vite's normal
      // transform pipeline (and can break when force-prebundled into deps chunks).
      exclude: [
        "@blocksuite/affine",
