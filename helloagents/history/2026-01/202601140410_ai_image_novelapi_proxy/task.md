...
目录: `helloagents/plan/202601140410_ai_image_novelapi_proxy/`
...
## 2. /ai-image 页面能力增强
- [√] 2.1 在 `app/routes/aiImage.tsx` 中改为 Web 走 `/api/novelapi`、Electron 走 IPC，并统一二进制解析与错误展示，验证 why.md#需求-web-环境可通过代理稳定出图-场景-web-端点击生成 与 why.md#需求-electron-环境保持可出图且解析-zip图片-场景-electron-内点击生成
