...
Ŀ¼: `helloagents/plan/202601172100_ai_image_char_bg_layout/`
...
- [√] 1.3 在 `app/routes/aiImage.tsx` 将普通/רҵģʽ UI 统一为三栏布局并复用中间/右侧区域，验证 why.md#需求-两模式三栏对齐-场景-普通模式一键生成后继续编辑
