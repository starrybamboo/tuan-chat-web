...
### 需求: 拖拽时自动上滚
**模块:** chat
拖拽消息靠近列表顶部时，列表应自动上滚；离开触发区或结束拖拽后停止。
...
- 入口位于房间顶部导入按钮（位于导出按钮左侧）：支持选择 `.txt` 文件或粘贴文本
...
- [202601231822_chat-drag-scroll](../../history/2026-01/202601231822_chat-drag-scroll/) - 拖拽移动消息时支持顶部自动上滚
